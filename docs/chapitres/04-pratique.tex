...
\notion{Un checkpoint récent possède un champ \code{tokenizer}.
La fonction \code{tokenizer\_from\_state} le reconstruit.
Sinon, le chargeur suit la branche historique :
...
À l'inférence, le chargeur crée le modèle, charge les poids, puis appelle
...
\attention{Conserver dans les données archivées l'intitulé complet
\code{training\_\allowbreak tokens\_\allowbreak per\_\allowbreak second\_\allowbreak including\_\allowbreak validation},
quitte à l'expliquer en français dans un graphique.
